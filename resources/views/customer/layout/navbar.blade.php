    ...
    <li class="dropdown">
        <a class="nav-link dropdown-toggle nav-user" data-bs-toggle="dropdown" href="#" role="button"
            ...
            <div class="d-flex align-items-center">
                ...
                @endif
                <div class="user-name">
                    <small class="d-none d-lg-block font-11">{{ Str::upper(Auth::user()->role) }}</small>
...
<style>
    ...
    .dropdown-menu {
        background-color: #ff7700; /* Warna orange */
        border-radius: 15px;
        padding: 10px;
        border: none;
    ...
    .dropdown-menu .dropdown-item {
        color: #ffffff !important; /* Warna teks awal putih */
        padding: 10px 15px;
        border-radius: 8px;
        transition: background-color 0.3s, transform 0.2s, color 0.3s, font-size 0.2s;
    }

    .dropdown-menu .dropdown-item:hover {
        background-color: rgba(0, 0, 0, 0.1); /* Tambah background gelap tipis pas hover */
        transform: scale(1.05); /* Geser + membesar 5% */
        color: #dcdcdc !important; /* Teks jadi sedikit gelap pas hover */
    }
