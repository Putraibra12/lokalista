                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-xl-6">
                                        <div class="card">
                                            ...
                                            <!--end card-header-->
                                            <div class="card-body">
                                                <form action="{{ route('superadmin.profile_data_update', Auth::user()->id) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('put')
                                    ...
                                    <div class="col-lg-6 col-xl-6">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <form
                                                    action="{{ route('superadmin.profile_password_update', Auth::user()->id) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('put')
                                                    <div class="form-group mb-3 row">
    ...
    <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <!--end modal-header-->
                <form action="{{ route('superadmin.profile_foto_update', Auth::user()->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('put')
